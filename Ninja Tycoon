if game.CoreGui:FindFirstChild("emptynessHub") then
    game.CoreGui.emptynessHub:Destroy()
end
game:GetService("UserInputService").InputBegan:connect(
    function(key, gpe)
        if key.KeyCode == Enum.KeyCode.RightControl then
            game.CoreGui.emptynessHub.Enabled = not game.CoreGui.emptynessHub.Enabled
        end
    end
)
...
h4x.Parent = game.CoreGui
	h4x.Name = "emptynessHub"
	h4x.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
	h4x.ResetOnSpawn = false
...
title.Text = "Ninja Tycoon GUI old"
...
Xclose.Name = "Xclose"
Xclose.Parent = main
Xclose.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Xclose.BackgroundTransparency = 1.000
Xclose.Position = UDim2.new(0.55160141, 0, 0.927710831, 0)
Xclose.Size = UDim2.new(0, 126, 0, 36)
Xclose.Font = Enum.Font.SourceSans
Xclose.Text = "X"
Xclose.TextColor3 = Color3.fromRGB(255, 255, 255)
Xclose.TextScaled = true
Xclose.TextSize = 45.000
...
credits_2.Text = "This script is not mind"
